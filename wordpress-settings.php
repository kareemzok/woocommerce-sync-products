...
abstract class WordPressSettings {
    ...
    public function render_text($field) {
        ...
        <tr>
            ...
            <td>
                <input type="<?php echo $type; ?>" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php echo $default; ?>" placeholder="<?php echo $placeholder; ?>" style="<?php echo $style; ?>" <?php echo $readonly_text; ?> />	
                <?php
                if ($desc != '') {
    ...
    public function render_div($field) {
        ...
        <tr>
            <th>
                <div id="<?php echo $id; ?>" class="<?php echo $class ?>" style="<?php echo $style ?>"><?php echo $default; ?></div>
            </th>
            <td>
            </td>
        </tr>
     ...
     * @return bool
     */
    function woocommerce_sync_product_is_configured() {
        $bool = false;
        $settings_var = get_option('woocommerce_products-sync-integration_settings');

        if ($settings_var['rest_api_link'] != "") {
            $bool = true;
        }
        return $bool;
    }
     ...
     * @return bool
     */
    function check_if_woocoommerce_active() {
        $bool = false;
